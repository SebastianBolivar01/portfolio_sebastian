...
export const translations: Record<Lang, TranslationSchema> = {
  en: {
    ...
    footerDesc: "Full-Stack Developer crafting modern, scalable, and beautiful digital experiences from Colombia 🇨🇴",
  ...
  es: {
    ...
    footerGetInTouch: "Contacto",
    footerDesc: "Desarrollador Full-Stack creando experiencias digitales modernas, escalables y hermosas desde Colombia 🇨🇴",
  ...
  it: {
    ...
    footerGetInTouch: "Contattami",
    footerDesc: "Sviluppatore Full-Stack che crea esperienze digitali moderne e belle dalla Colombia 🇨🇴",
    footerCTA: "Lavoriamo Insieme",
    footerBuiltWith: "Costruito con",
    proj1Title: "UniShop Frontend",
  ...
  pt: {
    ...
    footerGetInTouch: "Fale Comigo",
    footerDesc: "Desenvolvedor Full-Stack criando experiências digitais modernas e bonitas da Colômbia 🇨🇴",
